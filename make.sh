...
gcc -o flowtosql flowtosql.c -I`pg_config --includedir` `pkg-config --cflags glib-2.0` `pkg-config --libs glib-2.0` -lpq -std=gnu99 -O2 -pipe -Wno-unused-result -march=native -Wall
echo "Building tobin..."
